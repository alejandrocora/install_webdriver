...
if [ $target == 2 ] || [ $target == 3 ]; then
	...
	echo -n "	>"
	read selection
	chrome_version=$((selection-1))
	chrome_download=https://chromedriver.storage.googleapis.com/${chrome_versions[chrome_version]}/chromedriver_linux$architecture.zip
